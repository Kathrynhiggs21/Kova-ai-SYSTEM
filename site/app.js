...
const fallbackDashboardData = {
  ...
  "blockers": [
    ...
    "Duplicate/legacy Vercel projects must be owner-reviewed for unique env/domain settings before owner-only unlink/delete console actions."
  ],
  "next_actions": [
    "Merge architecture changes only after exact-head CI and review pass.",
    "Create or verify the canonical Vercel project linked to Kathrynhiggs21/kovaos-site.",
    "Confirm kova-ai-system remains the canonical backend deployment.",
    "Compare env vars/domains/aliases for kova-ai-system-sl9b, v0-kova-ai, kova-ai-z3fs, and kova-os-docengine-kpsl before duplicate cleanup.",
    "After owner verification, remove Git integration or delete duplicate projects from the Vercel console only.",
    "Verify /, /dashboard, /ai, /files, /settings, and owner/admin routes after frontend cutover.",
